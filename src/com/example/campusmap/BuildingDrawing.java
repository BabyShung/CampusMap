...
public class BuildingDrawing {
	...
	private void drawAllTheCampusBuildings() {
		...
		buildingSet.put(1, new Building("Meclean Hall","address1",new LatLng(41.661017, -91.536656), new LatLng(41.661017,
				-91.536420), new LatLng(41.660418, -91.536420), new LatLng(
				41.660418, -91.536656)));
		buildingSet.put(2, new Building("Jessup Hall","address2",new LatLng(41.662203, -91.536628), new LatLng(41.662203,
				-91.536393), new LatLng(41.661598, -91.536400), new LatLng(
				41.661598, -91.536635)));
//		buildingSet.put(2, new Building("Main Library","address3",new LatLng(41.659932, -91.538974), new LatLng(41.659932,
//				-91.537903), new LatLng(41.659144, -91.537903), new LatLng(
//				41.659144, -91.538974)));
